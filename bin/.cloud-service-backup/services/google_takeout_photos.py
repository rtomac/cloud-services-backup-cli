...
class GoogleTakeoutPhotos(GoogleTakeoutExtensionService):
    """
To do
    """
    ...
    def _sync_exports(self, subcommand: str) -> None:
        for extract_dir in self._get_extract_dirs():
            ...
            for source_album_dir in list_subdirs(source_root_dir):
                ...
                self._sync_album(subcommand, source_album_dir, dest_album_dir)

    def _sync_album(self, subcommand: str, source_album_dir: Path, dest_album_dir: Path) -> None:
